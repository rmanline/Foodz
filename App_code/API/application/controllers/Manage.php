...
class Manage extends CI_Controller{
    ...
    public $_table_column_array = ['app_close','message','date_time'];
    public $_table_column_edit = ['id','app_close','message','date_time'];
    public $required = ['id'];
    ...
    public function save(){
        ...
        if($tokenStatus == 200){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Manage_model->saveList($_POST);
                if($result != null){
                    $id = $this->db->insert_id();
                    $data = $this->Manage_model->getByIdValue($id);
                    echo $this->json->response($data,$this->_OKmessage,$this->_statusOK);
                }else{
    ...
    public function editList(){
        ...
        if($tokenStatus == 200){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Manage_model->editList($_POST,$_POST['id']);
