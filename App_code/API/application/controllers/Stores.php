...
class Stores extends CI_Controller{
    ...
    public $_table_column_array = ['uid','name','mobile','lat','lng','verified','address','descriptions','images','cover','status','open_time','close_time','isClosed','certificate_url','certificate_type','rating','total_rating','cid','commission'];
    public $_table_column_edit = ['id','uid','name','mobile','lat','lng','verified','address','descriptions','images','cover','status','open_time','close_time','isClosed','certificate_url','certificate_type','rating','total_rating','cid','commission'];
    public $required = ['id'];
    ...
    public function editByUid(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Stores_model->editByUid($_POST,$_POST['id']);
