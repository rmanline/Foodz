...
class Popup extends CI_Controller{
    ...
    public $_table_column_array = ['shown','message','date_time'];
    public $_table_column_edit = ['id','shown','message','date_time'];
    public $required = ['id'];
    ...
    public function save(){
        ...
        if($tokenStatus == 200){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Popup_model->saveList($_POST);
                if($result != null){
                    $id = $this->db->insert_id();
                    $data = $this->Popup_model->getByIdValue($id);
                    echo $this->json->response($data,$this->_OKmessage,$this->_statusOK);
                }else{
    ...
    public function editList(){
        ...
        if($tokenStatus == 200){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Popup_model->editList($_POST,$_POST['id']);
