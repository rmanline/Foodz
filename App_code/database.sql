...
--
-- Host: localhost:3306
-- Generation Time: Jan 24, 2021 at 09:09 AM
...
--
-- Database: `initsmps_initstor_grocery`
--
...
INSERT INTO `general` (`id`, `mobile`, `email`, `address`, `city`, `state`, `zip`, `country`, `min`, `free`, `tax`, `shipping`, `shippingPrice`) VALUES
(1, '9426585554', 'your@mail.com', '567  Bridge Street Tulsa Oklahoma 74120', 'Ho', 'Volta', 74120, 'Ghana', 20.00, 100.00, 21.00, 'km', 7.00);
...
INSERT INTO `manage` (`id`, `app_close`, `message`, `date_time`) VALUES
(1, 1, '', '2020-09-16 12:39:20');
...
INSERT INTO `payments` (`id`, `name`, `env`, `creds`, `status`) VALUES
(1, 'Stripe', 1, '{\"test\":\"test\",\"live\":\"test\",\"code\":\"INR\"}', 1),
(2, 'COD', 1, 'cod', 1),
(3, 'PayPal', 0, '{\"test\":\"test\",\"live\":\"test\",\"code\":\"USD\"}', 1),
(4, 'RazorPay', 1, '{\"test\":\"test\",\"live\":\"test\",\"code\":\"INR\"}', 1),
(5, 'PayTM', 0, '{\"id\":\"test\",\"key\":\"test\",\"code\":\"INR\"}', 1),
(6, 'InstaMojo', 0, '{\"key\":\"test\",\"token\":\"test\",\"code\":\"INR\"}', 1),
(7, 'PayStack', 1, '{\"sk\":\"test\",\"pk\":\"test\",\"code\":\"NGN\"}', 1),
(8, 'Flutterwave', 1, '{\"pk\":\"test-X\",\"code\":\"NGN\"}', 1);
...
INSERT INTO `popup` (`id`, `shown`, `message`, `date_time`) VALUES
(1, 1, 'Get upto 30% off on fruits and free delivery over 100$ purchase', '2020-09-03 10:16:84');
...
INSERT INTO `settings` (`id`, `currencySymbol`, `currencySide`, `appDirection`, `logo`, `twillo`, `creds`, `delivery`, `reset_pwd`, `user_login`, `store_login`, `driver_login`, `web_login`, `web_category`) VALUES
(1, '$', 'left', 'ltr', 'icon2.png', 1, '{\"sid\":\"test\",\"token\":\"test\",\"from\":\"test\"}', 1, 0, 0, 0, 0, 0, '');
...
(1, 'rahuljograna007@gmail.com', '2021-01-18 18:30:00');
