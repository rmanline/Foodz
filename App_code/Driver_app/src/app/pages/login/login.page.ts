      ...
      if (data && data.status === 200) {
        ...
        if (data.data.data.status === '1') {
          ...
          if (fcm && fcm !== null && fcm !== 'null') {
            ...
            this.api.post_private('drivers/edit_profile', updateParam).subscribe((data: any) => {
  ...
  async openModal(uid) {
    ...
    modal.onDidDismiss().then((data) => {
      ...
      if (data && data.role === 'success') {
        ...
        this.api.post('drivers/getByIdWithToken', param).subscribe((data: any) => {
          console.log('user data', data);
          if (data && data.status === 200 && data.data.data && data.data.data.length) {
